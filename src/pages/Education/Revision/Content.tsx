import { Alert, Button, ButtonGroup, ContentState, Header, Jumbotron, Line, Switch } from 'sefer/components';
...
export const Content = (props: { course: CourseWithRevisions }) => {
  ...
  const save = async () => {
    const saving = async () => {
      setState('saving');
      await putRevision({ ...course.editingRevision, allowSelfStudy: allowed });
    };
